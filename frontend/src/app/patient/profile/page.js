...
export default function PatientProfilePage() {
  ...
  const [medicalId, setMedicalId] = useState(patient?.medicalId || '');
  const [address, setAddress] = useState(patient?.address || '');
  const [city, setCity] = useState(patient?.city || 'New York');
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto' }}>
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#64748b' }}>
            Manage your patient identification and billing contact details.
          </p>
        </div>
        ...
        <div className="card" style={{ padding: '32px' }}>
          ...
          <form onSubmit={handleSave}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              ...
              <div className="form-group">
                <label className="form-label">Medical Record / Patient ID</label>
                <input
                  type="text"
                  className="form-input"
                  value={medicalId}
